...
export default function ChatWindow({selectedUser ,messages, setMessages, socket,setSelectedUser}) {
 if (!selectedUser) {
  return (
    <div className='flex-1 flex flex-col h-screen bg-gray-950 items-center justify-center gap-4'>
